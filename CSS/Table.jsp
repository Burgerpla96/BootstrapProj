  ...
  <body>
  	<div class="container">
  		<div class="page-header">
  			<h1>Table Example<small>table 연습입니다.</small></h1>
  		</div>
  		<div class="row">
  		...
  		.table 을 .table-responsive 으로 감싸서 작은 기기에서는
  		수평 스크롤을 할 수 있는 반응형 테이블을 만듭니다(768px 이하). 
  		768px 보다 큰 기기에서는 보기에 차이가 없습니다.
  		column 최소 6개 이상있어야 한다. 
  		-->
  		<div class="row">
